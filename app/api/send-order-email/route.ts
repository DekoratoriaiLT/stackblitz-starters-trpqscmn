...
// ---------------------------------------------------------------------------
// Configure your email transport via environment variables:
//
//   EMAIL_HOST       e.g. smtp.gmail.com
//   EMAIL_PORT       e.g. 587
//   EMAIL_USER       e.g. yourshop@gmail.com
//   EMAIL_PASS       e.g. app-specific password
//   EMAIL_FROM       e.g. "Mano Parduotuvė <yourshop@gmail.com>"
//   STORE_EMAIL      the inbox that receives order notifications
// ---------------------------------------------------------------------------
...
<body style="font-family:Arial,sans-serif;background:#f9f9f9;margin:0;padding:0;">
  <div style="max-width:600px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
    ...
    <div style="background:#f3f4f6;padding:16px 40px;text-align:center;">
      <p style="color:#9ca3af;font-size:12px;margin:0;">© ${new Date().getFullYear()} Jūsų parduotuvė. Visos teisės saugomos.</p>
    </div>
  </div>
</body>
</html>`;
