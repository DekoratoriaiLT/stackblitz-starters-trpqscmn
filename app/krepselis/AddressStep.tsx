...
export default function AddressStep({
    ...
    useEffect(() => {
        ...
        AddressFinder.watch({
            ...
            onAddressRetrieved: (address: AnyAddress) => {
                const line_1 = getField(address, "line_1") ?? "";
                const line_2 = getField(address, "line_2") ?? "";
                const city =
                ...
                setAddressState({ line_1, line_2, city, postal_code: postal, country });
            }
        });
    }, [setAddressState]);
    ...
    const isValid =
        ...
        addressState.line_1.trim() &&
        addressState.city.trim() &&
        addressState.postal_code.trim() &&
        addressState.country.trim();

    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-medium mb-6">Pristatymo informacija</h2>

            {/* CUSTOMER DETAILS */}
            <div className="mb-6">
                <h3 className="text-base font-medium text-gray-700 mb-4">Kontaktiniai duomenys</h3>
            ...
            {/* ADDRESS SEARCH */}
            <h3 className="text-base font-medium text-gray-700 mb-4">Pristatymo adresas</h3>
            ...
            <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Adresas 1 *</label>
                        <input
                            id="line_1"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Adresas 2</label>
                        <input
                            id="line_2"
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            setAddressState({ ...addressState, country: normalizeCountryCode(e.target.value) })
                        }
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black text-black"
                    />
                </div>
