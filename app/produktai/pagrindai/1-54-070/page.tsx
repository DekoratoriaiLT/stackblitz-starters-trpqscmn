...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-54-070`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.54.070') || await getProduct('1-54-070');

  if (!product) {
    return <div>Produktas nerastas (1.54.070)</div>;
  }
