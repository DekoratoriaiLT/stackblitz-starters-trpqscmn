...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-47-301`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.47.301') || await getProduct('4-47-301');

  if (!product) {
    return <div>Produktas nerastas (4.47.301)</div>;
  }
