...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-54-040`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.54.040') || await getProduct('1-54-040');

  if (!product) {
    return <div>Produktas nerastas (1.54.040)</div>;
  }
