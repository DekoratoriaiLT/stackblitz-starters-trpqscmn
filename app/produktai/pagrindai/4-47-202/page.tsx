...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-47-202`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.47.202') || await getProduct('4-47-202');

  if (!product) {
    return <div>Produktas nerastas (4.47.202)</div>;
  }
