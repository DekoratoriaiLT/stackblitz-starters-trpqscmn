...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-64-813`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.64.813') || await getProduct('1-64-813');

  if (!product) {
    return <div>Produktas nerastas (1.64.813)</div>;
  }
