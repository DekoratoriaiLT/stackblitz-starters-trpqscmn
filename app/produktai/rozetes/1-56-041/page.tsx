...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-56-041`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.56.041') || await getProduct('1-56-041');

  if (!product) {
    return <div>Produktas nerastas (1.56.041)</div>;
  }
