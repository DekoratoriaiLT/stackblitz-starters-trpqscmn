...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-56-032`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.56.032') || await getProduct('1-56-032');

  if (!product) {
    return <div>Produktas nerastas (1.56.032)</div>;
  }
