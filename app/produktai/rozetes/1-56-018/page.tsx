...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-56-018`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.56.018') || await getProduct('1-56-018');

  if (!product) {
    return <div>Produktas nerastas (1.56.018)</div>;
  }
