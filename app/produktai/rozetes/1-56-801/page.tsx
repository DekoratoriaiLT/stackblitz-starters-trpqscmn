...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-56-801`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.56.801') || await getProduct('1-56-801');

  if (!product) {
    return <div>Produktas nerastas (1.56.801)</div>;
  }
