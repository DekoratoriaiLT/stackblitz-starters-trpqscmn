...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-20-103`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.20.103') || await getProduct('4-20-103');

  if (!product) {
    return <div>Produktas nerastas (4.20.103)</div>;
  }
