...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-20-301`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.20.301') || await getProduct('1-20-301');

  if (!product) {
    return <div>Produktas nerastas (1.20.301)</div>;
  }
