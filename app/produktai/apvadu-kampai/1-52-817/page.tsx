...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-52-817`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.52.817') || await getProduct('1-52-817');

  if (!product) {
    return <div>Produktas nerastas (1.52.817)</div>;
  }
