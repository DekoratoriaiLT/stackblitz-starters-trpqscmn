...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-54-014`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.54.014') || await getProduct('1-54-014');

  if (!product) {
    return <div>Produktas nerastas (1.54.014)</div>;
  }
