...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-84-006`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.84.006') || await getProduct('4-84-006');

  if (!product) {
    return <div>Produktas nerastas (4.84.006)</div>;
  }
