...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-84-051`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.84.051') || await getProduct('4-84-051');

  if (!product) {
    return <div>Produktas nerastas (4.84.051)</div>;
  }
