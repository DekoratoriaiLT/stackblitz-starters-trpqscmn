...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/0-1-61-102-1-61-120`;
...
export default async function Page() {
  ...
  const product = await getProduct('0.1.61.102.1.61.120') || await getProduct('0-1-61-102-1-61-120');

  if (!product) {
    return <div>Produktas nerastas (0.1.61.102.1.61.120)</div>;
  }
