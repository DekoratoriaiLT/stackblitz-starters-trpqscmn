...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/0-1-61-101-1-61-110`;
...
export default async function Page() {
  ...
  const product = await getProduct('0.1.61.101.1.61.110') || await getProduct('0-1-61-101-1-61-110');

  if (!product) {
    return <div>Produktas nerastas (0.1.61.101.1.61.110)</div>;
  }
