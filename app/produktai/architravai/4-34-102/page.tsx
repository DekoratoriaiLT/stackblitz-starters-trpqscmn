...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-34-102`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.34.102') || await getProduct('4-34-102');

  if (!product) {
    return <div>Produktas nerastas (4.34.102)</div>;
  }
