...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-19-137`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.19.137') || await getProduct('1-19-137');

  if (!product) {
    return <div>Produktas nerastas (1.19.137)</div>;
  }
