...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-19-013`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.19.013') || await getProduct('1-19-013');

  if (!product) {
    return <div>Produktas nerastas (1.19.013)</div>;
  }
