...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-30-202`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.30.202') || await getProduct('1-30-202');

  if (!product) {
    return <div>Produktas nerastas (1.30.202)</div>;
  }
