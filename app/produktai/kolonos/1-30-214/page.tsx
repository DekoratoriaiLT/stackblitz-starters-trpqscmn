...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-30-214`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.30.214') || await getProduct('1-30-214');

  if (!product) {
    return <div>Produktas nerastas (1.30.214)</div>;
  }
