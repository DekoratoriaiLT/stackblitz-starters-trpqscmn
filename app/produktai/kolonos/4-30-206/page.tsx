...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-30-206`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.30.206') || await getProduct('4-30-206');

  if (!product) {
    return <div>Produktas nerastas (4.30.206)</div>;
  }
