...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-59-903`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.59.903') || await getProduct('1-59-903');

  if (!product) {
    return <div>Produktas nerastas (1.59.903)</div>;
  }
