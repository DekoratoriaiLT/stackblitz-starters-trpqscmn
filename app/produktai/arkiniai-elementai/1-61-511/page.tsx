...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-61-511`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.61.511') || await getProduct('1-61-511');

  if (!product) {
    return <div>Produktas nerastas (1.61.511)</div>;
  }
