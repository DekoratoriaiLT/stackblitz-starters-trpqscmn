...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-21-006`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.21.006') || await getProduct('1-21-006');

  if (!product) {
    return <div>Produktas nerastas (1.21.006)</div>;
  }
