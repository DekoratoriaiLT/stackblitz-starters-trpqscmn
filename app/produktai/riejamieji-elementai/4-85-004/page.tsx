...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-85-004`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.85.004') || await getProduct('4-85-004');

  if (!product) {
    return <div>Produktas nerastas (4.85.004)</div>;
  }
