...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-50-288`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.50.288') || await getProduct('1-50-288');

  if (!product) {
    return <div>Produktas nerastas (1.50.288)</div>;
  }
