...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-50-158`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.50.158') || await getProduct('1-50-158');

  if (!product) {
    return <div>Produktas nerastas (1.50.158)</div>;
  }
