...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-50-124`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.50.124') || await getProduct('1-50-124');

  if (!product) {
    return <div>Produktas nerastas (1.50.124)</div>;
  }
