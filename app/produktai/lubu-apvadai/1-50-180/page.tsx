...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-50-180`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.50.180') || await getProduct('1-50-180');

  if (!product) {
    return <div>Produktas nerastas (1.50.180)</div>;
  }
