...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-60-019`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.60.019') || await getProduct('1-60-019');

  if (!product) {
    return <div>Produktas nerastas (1.60.019)</div>;
  }
