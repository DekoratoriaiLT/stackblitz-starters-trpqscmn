...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-87-031`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.87.031') || await getProduct('4-87-031');

  if (!product) {
    return <div>Produktas nerastas (4.87.031)</div>;
  }
