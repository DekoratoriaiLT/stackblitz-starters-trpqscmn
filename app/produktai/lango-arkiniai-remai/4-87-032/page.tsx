...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-87-032`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.87.032') || await getProduct('4-87-032');

  if (!product) {
    return <div>Produktas nerastas (4.87.032)</div>;
  }
