...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/4-87-033`;
...
export default async function Page() {
  ...
  const product = await getProduct('4.87.033') || await getProduct('4-87-033');

  if (!product) {
    return <div>Produktas nerastas (4.87.033)</div>;
  }
