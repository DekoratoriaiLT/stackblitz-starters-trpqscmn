...
const generateProductJsonLd = (product: any) => {
  ...
  const productUrl = `${BASE_URL}/produktai/${CATEGORY}/1-53-110`;
...
export default async function Page() {
  ...
  const product = await getProduct('1.53.110') || await getProduct('1-53-110');

  if (!product) {
    return <div>Produktas nerastas (1.53.110)</div>;
  }
